...
function SelectAxes() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.header}>Task: Credit Score</h2>
      <div style={styles.instruction}>
        <p> In this task, you will be categorizing <b>individuals</b> according to their <b>credit score</b> <span style={{fontSize: '1.5em'}}>💰</span>.</p>
        <p> Just like with the practice task, get started by selecting attributes to show on the x-axis 
          and y-axis that you would like to see when you begin the task. </p>
      </div>
...
//         <h2 style={{marginTop: '40px'}}>Task: Credit Score</h2> 
//         <p style={{lineHeight: '1.5'}}> In this task, you will be categorizing <b>individuals</b> according to their <br /><b>credit score 💰</b>.</p>

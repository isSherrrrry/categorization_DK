...
//           textAlign: 'center'
//       }}>
//           <h2>You are about to begin the exit survey.</h2>
//           <p style={{ fontSize: '15px' }}>Our system has successfully concluded the eye tracking data collection process. <br></br>
//             At this point, it is no longer necessary for your webcam to remain active. <br></br>
//             If you prefer, you may now safely turn off your webcam.</p>
//           <p><b>Click continue to start the exit survey. </b></p>
